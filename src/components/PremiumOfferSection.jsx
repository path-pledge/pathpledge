...
const PremiumOfferSection = () => {
  return (
    <motion.div
      ...
      className="bg-gray-100 p-6 sm:p-8 rounded-2xl flex flex-col md:flex-row justify-between items-stretch space-y-6 md:space-y-0 md:space-x-12"
    >
      ...
      <div className="md:w-1/2 flex flex-col justify-center space-y-4">
        ...
        >
          With Just{" "}
          <span className="text-[#D9070A]">₹3000/-</span> get 100 minutes of
          premium content to kickstart your Trading Journey.
        </motion.h2>
